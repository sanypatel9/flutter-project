...
import 'package:practical_demo/screens/add_user.dart';
import 'package:practical_demo/screens/edit_user.dart';
import 'package:practical_demo/screens/view_user.dart';
  ...
  getAllUserDetails() async {
    ...
    users.forEach((user) {
      setState(() {
        ...
        userModel.maths = user['maths'];
        userModel.english = user['english'];
        userModel.gujarati = user['gujarati'];
